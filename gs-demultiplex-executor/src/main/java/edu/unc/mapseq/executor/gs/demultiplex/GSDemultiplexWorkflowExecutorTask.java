...
import edu.unc.mapseq.workflow.gs.demultiplex.GSDemultiplexWorkflow;

public class GSDemultiplexWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(GSDemultiplexWorkflowExecutorTask.class);
    ...
    public GSDemultiplexWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    GSDemultiplexWorkflow casavaWorkflow = new GSDemultiplexWorkflow();
