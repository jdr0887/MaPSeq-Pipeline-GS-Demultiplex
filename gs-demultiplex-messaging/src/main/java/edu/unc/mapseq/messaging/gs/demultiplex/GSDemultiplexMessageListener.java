...
public class GSDemultiplexMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(GSDemultiplexMessageListener.class);

    private String studyName;

    public GSDemultiplexMessageListener() {
        super();
    }
